...
public class CityListAdapter extends ArrayAdapter<Region> {
    ...
    public CityListAdapter(ArrayList<Region> regions, Context context) {
        super(context, R.layout.row_city_list, regions);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.row_city_list, parent, false);
